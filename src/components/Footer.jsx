      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
          ...
          <div className="flex gap-4">
            <li  className="w-12 h-12 rounded-full border-2 border-gray-600 flex items-center justify-center hover:border-blue-500 hover:bg-blue-500 transition-all">
              <FaFacebookF className="w-5 h-5" />
            </li>
            <li className="w-12 h-12 rounded-full border-2 border-gray-600 flex items-center justify-center hover:border-red-500 hover:bg-red-500 transition-all">
              <FaYoutube className="w-5 h-5" />
            </li>
            <li  className="w-12 h-12 rounded-full border-2 border-gray-600 flex items-center justify-center hover:border-pink-500 hover:bg-pink-500 transition-all">
              <FaInstagram className="w-5 h-5" />
            </li>
            <li  className="w-12 h-12 rounded-full border-2 border-gray-600 flex items-center justify-center hover:border-blue-600 hover:bg-blue-600 transition-all">
